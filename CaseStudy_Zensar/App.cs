...
namespace CaseStudy_Zensar
{
    public class App
    {
        public static void scenario1_Student()
        {
            ...
            Student s1 = new Student(101, "Simi", Convert.ToDateTime("07 - 01 - 2001"));
            i1.display(s1);
            Student s2 = new Student(102, "Namita", Convert.ToDateTime("01 / 02 / 1998"));
            i1.display(s2);
            Student s3 = new Student(103, "Sakshi", Convert.ToDateTime("12 / 07 / 1996"));
            i1.display(s3);
            Student s4 = new Student(104, "Shalu", Convert.ToDateTime(" 17 / 05 / 1999"));
            i1.display(s4);
            Student s5 = new Student(105, "Chanchal", Convert.ToDateTime(" 18 / 08 / 1999"));
            i1.display(s5);
        }
        ...
        public static void scenario2_Student()
        {
            ...
            student[0] = new Student(106, "Somi", Convert.ToDateTime("04-05-2000"));
            student[1] = new Student(107, "Swaraj", Convert.ToDateTime("06/05/1999"));
            student[2] = new Student(108, "Trisha", Convert.ToDateTime("08/04/2004"));
            student[3] = new Student(109, "Richa", Convert.ToDateTime("03/02/2005"));
            student[4] = new Student(110, "Anisha", Convert.ToDateTime("01/09/2006"));
