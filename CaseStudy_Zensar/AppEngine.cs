...
namespace CaseStudy_Zensar
{
    internal class AppEngine
    {
        ...
        {
            con = new SqlConnection("Data Source=POOLW42NLPC0634;Initial Catalog=SMS;Integrated Security=True;MultipleActiveResultSets=True");
            con.Open();
            return con;
        }
        ...
        public void New_StudentRegistration()
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                Console.WriteLine("Enter Student StdName");
        ...
        public void Introducing_NewCourse()
        {
            ...
            for (int i = 0; i < no_Of_Courses; i++)
            {
                ...
                Console.WriteLine("Enter Course Details CourseId");
                CId = Convert.ToInt32(Console.ReadLine());

                Console.WriteLine("Enter Course Details CourseName");
                CName = Console.ReadLine();

                Console.WriteLine("Enter Course Details Duration");
                Duration = Console.ReadLine();

                Console.WriteLine("Enter Course Details Fee_Structure");
